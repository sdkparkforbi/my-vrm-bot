        ...
        >
          ...
          {!videoReady && (
            <div className={styles.placeholder}>
              ...
              <p className={styles.placeholderText}>AI 아바타</p>
              <p className={styles.placeholderSub}>나의 AI 봇</p>
            </div>
          )}
          ...
          {videoReady && (
            <div className={styles.nameplate}>
              <div className={styles.nameplateInner}>
                <span className={styles.nameplateName}>AI 아바타</span>
                <span className={styles.nameplateSub}>나의 AI 봇</span>
              </div>
            </div>
          )}
